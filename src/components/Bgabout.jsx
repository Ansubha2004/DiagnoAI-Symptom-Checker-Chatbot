    ...
    <div>
      <div className="h-auto w-auto absolute z-2 bg-[#0C0C0C]">
        ...
        <div className="relative w-screen h-screen" id="two">
          <img className="w-[358px] h-[358px] absolute top-1/30 left-[50px] transform  rotate-y-180 z-1 opacity-70 " src={bot1} alt="" />
        ...
        <div className="relative w-screen h-screen" id="three">
          ...
          <img className=" w-[346px] h-[346px] absolute top-1/3 right-1/12 z-1  " src={bot2} id="b2" alt="" />
